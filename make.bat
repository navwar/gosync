...
rem # ==================================================================================
rem #
rem # Work of the U.S. Department of the Navy, Naval Information Warfare Center Pacific.
...
if %1%==bin\gosync.exe (
  ...
  go build -o bin/gosync.exe github.com/navwar/gosync/cmd/gosync
...
if %1%==imports (
  ...
  .\bin\goimports.exe -w ^
  -local github.com/gruntwork-io/terratest,github.com/aws/aws-sdk-go,github.com/navwar ^
  -l ^
  .\cmd\gosync ^
  .\pkg\fs ^
  .\pkg\lfs ^
...
if %1%==vet (
  ...
  go vet github.com/navwar/gosync/pkg/...
  go vet github.com/navwar/gosync/cmd/...
